...
@Composable
fun ActivityLevelScreen(modifier: Modifier = Modifier, onContinue: () -> Unit) {
    ...
    Column(
        ...
        Icon(painter = painterResource(id = R.drawable.img_1), contentDescription = "Activity", tint = Color(0xFFFF0000))
        Spacer(modifier = Modifier.height(16.dp))
        Text(text = "How active are you?", fontSize = 18.sp)
        Spacer(modifier = Modifier.height(8.dp))
        Text(text = activityLevel, fontSize = 24.sp, fontWeight = FontWeight.Bold, color = Color(0xFF4CAF50))
        Slider(
